...
public:
    ...
    // Hàm tính TỔNG ĐIỂM của Người chơi 1 (P1)
    // Bằng: (Số quân đã ăn * 5) + Số quân còn đang nằm trên 5 ô dân của P1
    ...
    // Hàm tính TỔNG ĐIỂM của Người chơi 2 (P2)
    // Bằng: (Số quân đã ăn * 5) + Số quân còn đang nằm trên 5 ô dân của P2
